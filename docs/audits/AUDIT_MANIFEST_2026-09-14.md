...
| M5 | session_rollover.test.js 5/5; reaping 20/20; full `npm test` exit 0 | pending MCP-server-restart smoke (60-turn session → session_warning event in ledger) | this commit (M5a+fix) |
| M6 | — | — | — |
| M7 | — | — | — |
| M8 | — | — | — |
| M9 | — | — | — |
